...
<tr>
	...
	<td>
		<div class="form-check form-switch mt-2">
			@php 
				$switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'faqs', 'field' => 'status', 'id' => $row->id])
			@endphp
	...
	<td class="text-right">
		<div class="action_dropdown btn-group">
			...
			<ul class="dropdown-menu dropdown-menu-end">
				...
				<li>
					<a class="dropdown-item" href="{{ route('admin.faqs.edit', ['id' => $row->id]) }}">
				...
				<li>
					<a class="dropdown-item" href="{{ route('admin.faqs.view', ['id' => $row->id]) }}">
				...
				<li>
					<a class="dropdown-item delete_confirm" href="{{ route('admin.faqs.delete', ['id' => $row->id]) }}">
