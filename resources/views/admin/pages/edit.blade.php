		...
		<div class="row">
			...
			<div class="col-lg-6 col-5">
				<div class="right_area text-right">
					<a href="{{ route('admin.pages') }}" class="btn btn-default">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
    	...
    	<div class="row">
    		<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    			<div class="card">
    				<h5 class="card-header">Update Page Details Here.</h5>
    				<hr class="my-0" />
    				<div class="card-body">
    					<form action="{{ route('admin.pages.edit', ['id' => $page->id]) }}" method="post" class="form-validation">
    						<!--!! CSRF FIELD !!-->
    						{{ csrf_field() }}
    						<div class="row">
    							<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    							...
    							<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    								<div class="form-group">
    									<label class="form-label">Enter Page Description</label>
    									<textarea id="editor1" class="form-control" name="description" placeholder="Enter description">{{ old('description', $page->description) }}</textarea>
    							...
    							<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    								<div class="form-group">
    									...
    									<input type="text" class="form-control" name="meta_title" value="{{ old('meta_title', $page->meta_title) }}" placeholder="Enter meta title" />
    							...
    							<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    								<div class="form-group">
    									...
    									<input type="text" class="form-control" name="meta_keywords" value="{{ old('meta_keywords', $page->meta_keywords) }}" placeholder="Enter meta keywords" />
    							...
    							<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    								<div class="form-group">
    									...
    									<textarea class="form-control" name="meta_description" placeholder="Enter meta description">{{ old('meta_description', $page->meta_description) }}</textarea>
    							...
    							<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
    								<div class="form-group">
    									...
    									<div class="form-check form-switch mt-2">
    			                    		...
    			                    		<input type="checkbox" name="status" class="form-check-input" id="status" value="1" {{ old('status', $page->status) == 1 ? 'checked' : '' }}/>
